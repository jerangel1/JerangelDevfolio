...
export default function Home() {
  ...
  return (
    <main className="dark flex min-h-screen flex-col items-center justify-between p-24 overflow-x-hidden">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex mt-8 animate-fade-in">
        <p className="fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto  lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30">
          ...
          <a href="/pages/portfolio" target="_blank" className="dark:green">
            <code className="font-mono font-bold">My Projects</code>
          </a>
        </p>
      ...
      <h1 className="flex text-center ">Full Stack Developer</h1>
      <div className="animate-fade-in mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left">
        <Link
          href="/pages/about"
          className="dark:green animate-fade-in group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
          target="_blank"
          rel="noopener noreferrer"
        >
