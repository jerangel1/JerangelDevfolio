    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
        ...
        <div className="fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-1xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30 hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30">
          ...
          >
            { <span className="transform transition-transform group-hover:translate-x-3 motion-reduce:transform-none">
              -&gt;
      ...
      <iframe  src="https://lottie.host/embed/1b42b9b3-0187-4c82-a09d-c34ecb5e1a0d/Zu2IjUG0Zn.json"></iframe>
        <h2 className='relative flex place-items-center text-3xl font-bold tracking-tight text-zinc-100'>Hello, and welcome to my portfolio</h2>
      </div>
      
      <div className="mb-32 grid text-center lg:max-w-2xl lg:w-full lg:mb-0 lg:grid-cols-1 lg:text-left font-mono text-sm lg:flex">
