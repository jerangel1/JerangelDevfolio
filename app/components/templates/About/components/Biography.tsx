...
export const Biography = () => (
   ...
   transition-all duration-300 hover:text-white text-justify">
            In June 2020, from a small corner in Venezuela,
            I embarked on an unexpected journey into the digital universe.
            Armed with nothing but a Wix account and unwavering determination,
            I took my first steps into web development. The result?
            A spark that ignited into a full-blown passion for coding.
        </p>
   ...
   dark:drop-shadow-[0_0_1.9rem_#ffffff70]">
            Welcome to a space where ideas come to life, one line of code at a time.
        </p>
    </div>
);